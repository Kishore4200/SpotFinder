...
public class mainProgramModified {
	public static void main (String args[]) throws IOException {
		...
		FileInputStream fileReader = new FileInputStream("https://docs.google.com/document/d/1rFD0Uxgo4rjzQKnHB794GJnfgWfJXWdI1BkWZRRNNpU/edit?usp=sharing");		// creates fileReader, a new FileInputStream for the file containing all the spots' information		

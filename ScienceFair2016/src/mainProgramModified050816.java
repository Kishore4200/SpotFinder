...
public class mainProgramModified050816 {
	...
	public static void main (String args[]) throws IOException {
		...
		// resets the file and populates a two-dimensional array
		// resets the file reading mechanism
...
//============================================ START OF COMPUTATION SECTION ====================================================
		...
		if ((findingClosestSpots050816.closestSpots(allArrays, 0, spotsCount, attributesCount))[0][0] == null) {										// passes the necessary parameters into the closestSpots() method in the findingClosestSpots050816 class, and checks if the first element of the output is null --> indicates that no spots were found by the method and there are no empty spots left
			...
			for (int threeSpots = 0; threeSpots < 3; threeSpots++) {							
				if (!((findingClosestSpots050816.closestSpots(allArrays, choiceNumber, spotsCount, attributesCount))[threeSpots][0]==null) &&
						foundSpotToReserve == false &&												
						messageDisplayed == false) {											
					ImageIcon imgIcon = new ImageIcon("C:\\Kishore\\Grade9(2015-2016)\\ScienceFair\\SpotsMaps\\mapSpot" + 		
						(findingClosestSpots050816.closestSpots(allArrays, choiceNumber, spotsCount, attributesCount))[threeSpots][0] + 
						".jpg");																												
					JOptionPane.showMessageDialog(null,																							
							"Closest empty spot: Spot " + (findingClosestSpots050816.closestSpots
									(allArrays, choiceNumber, spotsCount, attributesCount))[threeSpots][0] + "\n" +			
							"Location: Floor " + (findingClosestSpots050816.closestSpots
									(allArrays, choiceNumber, spotsCount, attributesCount))[threeSpots][1] + "\n" +					
							"Distance from Exit " + (choiceNumber+1) + ": " + 
								(findingClosestSpots050816.closestSpots(allArrays, choiceNumber, spotsCount, attributesCount))[threeSpots][2] + 
								" meters" + "\n\n",	
							"SpotFinder",																										
					...
					int reserveRequest = JOptionPane.showOptionDialog(null,																	
						...
						options2,																												
							options2[1]);																										
					if (reserveRequest == 0) {																									
						updatingSpotInfo050816.reserveSpot(Integer.valueOf(
								((findingClosestSpots050816.closestSpots(allArrays, choiceNumber, spotsCount, attributesCount))[threeSpots][0])
								.toString()), 
		...
		//========================== START OF USER INTERFACE SECTION AND COMPUTATION SECTION ==========================//	
			...
			if (choiceNumber == 0) {																// if the first choice is selected						
				...
				for (int threeSpots = 0; threeSpots < 3; threeSpots++) {							// incrementing variable for the three spots
					if (!((findingClosestSpots050816.closestToA(allArrays))[threeSpots][0]==null) && 		// if the input this section is not null
						...
						ImageIcon imgIcon = new ImageIcon("C:\\Kishore\\Grade9(2015-2016)\\ScienceFair\\SpotsMaps\\mapSpot" + 		
							(findingClosestSpots050816.closestToA(allArrays))[threeSpots][0] + 
						...
						JOptionPane.showMessageDialog(null,																					// informs the user of the spot pick
								"Closest empty spot: Spot " + (findingClosestSpots050816.closestToA(allArrays))[threeSpots][0] + "\n" +			// shows the spot number
								"Location: Floor " + (findingClosestSpots050816.closestToA(allArrays))[threeSpots][1] + "\n" +					// shows the spot floor
								"Distance from Exit A: " + (findingClosestSpots050816.closestToA(allArrays))[threeSpots][2] + " meters" + "\n\n",	// shows the distance from the requested entrance
						...
						if (reserveRequest == 0) {																							// if they request to reserve the spot
							updatingSpotInfo050816.reserveSpot(String.valueOf((findingClosestSpots050816.closestToA(allArrays))[threeSpots][0]));		// run the module for reserve that spot
		...
		if (choiceNumber == 1) {																	// if the second choice is selected	
			...
			boolean foundSpotToReserve = false;
			for (int threeSpots = 0; threeSpots < 3; threeSpots++) {
				if (!((findingClosestSpots050816.closestToB(allArrays))[threeSpots][0]==null) && 
						foundSpotToReserve == false &&
						messageDisplayed == false) {
					ImageIcon imgIcon = new ImageIcon("C:\\Kishore\\Grade9(2015-2016)\\ScienceFair\\SpotsMaps\\mapSpot" + (findingClosestSpots050816.closestToB(allArrays))[threeSpots][0] + ".jpg");
					JOptionPane.showMessageDialog(null,
							"Closest empty spot: Spot " + (findingClosestSpots050816.closestToB(allArrays))[threeSpots][0] + "\n" +
							"Location: Floor " + (findingClosestSpots050816.closestToB(allArrays))[threeSpots][1] + "\n" +
							"Distance from Exit A: " + (findingClosestSpots050816.closestToB(allArrays))[threeSpots][2] + " meters" + "\n\n",
							"SpotFinder",
							JOptionPane.INFORMATION_MESSAGE, imgIcon);
					int reserveRequest = JOptionPane.showOptionDialog(null,
							"If you would like to reserve this spot, select yes." + "\n" +
							...
							options2[1]);
					if (reserveRequest == 0) {
						updatingSpotInfo050816.reserveSpot(String.valueOf((findingClosestSpots050816.closestToB(allArrays))[threeSpots][0]));
						foundSpotToReserve = true;
					} else {
						JOptionPane.showMessageDialog(null, "---- Spot not reserved ----");
					}
			...
			if (choiceNumber == 2) {																// if the third choice is selected
				...
				boolean foundSpotToReserve = false;
				for (int threeSpots = 0; threeSpots < 3; threeSpots++) {
					if (!((findingClosestSpots050816.closestToC(allArrays))[threeSpots][0]==null) && 
							foundSpotToReserve == false &&
							messageDisplayed == false) {
						ImageIcon imgIcon = new ImageIcon("C:\\Kishore\\Grade9(2015-2016)\\ScienceFair\\SpotsMaps\\mapSpot" + (findingClosestSpots050816.closestToC(allArrays))[threeSpots][0] + ".jpg");
						JOptionPane.showMessageDialog(null,
								"Closest empty spot: Spot " + (findingClosestSpots050816.closestToC(allArrays))[threeSpots][0] + "\n" +
								"Location: Floor " + (findingClosestSpots050816.closestToC(allArrays))[threeSpots][1] + "\n" +
								"Distance from Exit A: " + (findingClosestSpots050816.closestToC(allArrays))[threeSpots][2] + " meters" + "\n\n",
								"SpotFinder",
								JOptionPane.INFORMATION_MESSAGE, imgIcon);
						int reserveRequest = JOptionPane.showOptionDialog(null,
								"If you would like to reserve this spot, select yes." + "\n" +
								...
								options2[1]);
						if (reserveRequest == 0) {
							updatingSpotInfo050816.reserveSpot(String.valueOf((findingClosestSpots050816.closestToC(allArrays))[threeSpots][0]));
							foundSpotToReserve = true;
						} else {
							JOptionPane.showMessageDialog(null, "---- Spot not reserved ----");
						}
			...
			if (choiceNumber == 3) {																// if the fourth choice is selected
				...
				boolean foundSpotToReserve = false;
				for (int threeSpots = 0; threeSpots < 3; threeSpots++) {
					if (!((findingClosestSpots050816.closestToD(allArrays))[threeSpots][0]==null) && 
							foundSpotToReserve == false &&
							messageDisplayed == false) {
						ImageIcon imgIcon = new ImageIcon("C:\\Kishore\\Grade9(2015-2016)\\ScienceFair\\SpotsMaps\\mapSpot" + (findingClosestSpots050816.closestToD(allArrays))[threeSpots][0] + ".jpg");
						JOptionPane.showMessageDialog(null,
								"Closest empty spot: Spot " + (findingClosestSpots050816.closestToD(allArrays))[threeSpots][0] + "\n" +
								"Location: Floor " + (findingClosestSpots050816.closestToD(allArrays))[threeSpots][1] + "\n" +
								"Distance from Exit A: " + (findingClosestSpots050816.closestToD(allArrays))[threeSpots][2] + " meters" + "\n\n",
								"SpotFinder",
								JOptionPane.INFORMATION_MESSAGE, imgIcon);
						int reserveRequest = JOptionPane.showOptionDialog(null,
								"If you would like to reserve this spot, select yes." + "\n" +
								...
								options2[1]);
						if (reserveRequest == 0) {
							updatingSpotInfo050816.reserveSpot(String.valueOf((findingClosestSpots050816.closestToD(allArrays))[threeSpots][0]));
							foundSpotToReserve = true;
						} else {
							JOptionPane.showMessageDialog(null, "---- Spot not reserved ----");
						}
			...
			if (choiceNumber == 4) {																// if the fifth choice is selected
				...
				boolean foundSpotToReserve = false;
				for (int threeSpots = 0; threeSpots < 3; threeSpots++) {
					if (!((findingClosestSpots050816.closestToE(allArrays))[threeSpots][0]==null) && 
							foundSpotToReserve == false &&
							messageDisplayed == false) {
						ImageIcon imgIcon = new ImageIcon("C:\\Kishore\\Grade9(2015-2016)\\ScienceFair\\SpotsMaps\\mapSpot" + (findingClosestSpots050816.closestToE(allArrays))[threeSpots][0] + ".jpg");
						JOptionPane.showMessageDialog(null,
								"Closest empty spot: Spot " + (findingClosestSpots050816.closestToE(allArrays))[threeSpots][0] + "\n" +
								"Location: Floor " + (findingClosestSpots050816.closestToE(allArrays))[threeSpots][1] + "\n" +
								"Distance from Exit A: " + (findingClosestSpots050816.closestToE(allArrays))[threeSpots][2] + " meters" + "\n\n",
								"SpotFinder",
								JOptionPane.INFORMATION_MESSAGE, imgIcon);
						int reserveRequest = JOptionPane.showOptionDialog(null,
								"If you would like to reserve this spot, select yes." + "\n" +
								...
								options2[1]);
						if (reserveRequest == 0) {
							updatingSpotInfo050816.reserveSpot(String.valueOf((findingClosestSpots050816.closestToE(allArrays))[threeSpots][0]));
							foundSpotToReserve = true;
						} else {
							JOptionPane.showMessageDialog(null, "---- Spot not reserved ----");
						}
